...
export function defineAction<I extends ZodObject<any> | undefined = undefined, O extends ZodTypeAny | undefined = undefined, R = any>(action: Action<I, O, R>) {
	return action as unknown as {
		input: I extends ZodObject<any> ? z.infer<I> : undefined;
		output: O extends ZodTypeAny ? z.infer<O> : R;
		handler: (input: I extends ZodObject<any> ? z.infer<I> : undefined, ctx: Context) => Promise<O extends ZodTypeAny ? z.infer<O> : R>;
	};
}
